...
function test() {
	...
	let statement1 = "To repeat a statement multiple times."
	let statement2 = "To decompose a program into several small subroutines."
	let statement3 = "To determine the execution time of a program."
	let statement4 = "To interrupt the execution of a program."
	console.log("1." + statement1);
	console.log("2." + statement2);
	console.log("3." + statement3);
	console.log("4." + statement4);
